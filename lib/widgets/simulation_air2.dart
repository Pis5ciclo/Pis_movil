...
class SimulationScreenAir2 extends StatelessWidget {
  final Service service;
  final String title;

  SimulationScreenAir2({super.key, required this.service, required this.title});

  Future<List<Map<String, dynamic>>> fetchSimulationData() async {
    final response = await service.simulationAir2();
