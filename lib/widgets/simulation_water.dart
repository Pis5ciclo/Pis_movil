...
class SimulationScreenWater extends StatelessWidget {
  final Service service;
  final String title;

  SimulationScreenWater(
      {super.key, required this.service, required this.title});

  Future<List<Map<String, dynamic>>> fetchSimulationData() async {
    final response = await service.simulationWater();
      ...
      body: FutureBuilder<List<Map<String, dynamic>>>(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            // Verifica si data tiene elementos antes de procesar
            if (data.isEmpty) {
